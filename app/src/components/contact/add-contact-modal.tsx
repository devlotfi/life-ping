...
export default function AddContactModal({ state }: AddContactModalProps) {
  ...
  const { mutate, isPending } = $api.useMutation("post", "/api/contacts", {
    onError() {
      toast(t("error"), {
        indicator: <InfoIcon />,
        variant: "danger",
      ...
      <Modal.Container placement="center">
        <Modal.Dialog>
          ...
          <Modal.Header>
            ...
            <Modal.Heading>{t("addContact")}</Modal.Heading>
          </Modal.Header>
